...
const Footer = () => {
    return (
        <div className='print:hidden'>
            <footer className="footer relative before:absolute before:inset-0 p-10 bg-[#8DD3BB] text-black mt-[200px]">
                <div className='mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 mt-[150px]'>
                    <img className='w-[100px]' src={logo} alt="" />
                </div>
                <div className='mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 mt-[100px]'>
                ...
                <div className="absolute bottom-[20%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[1232px] h-[250px] bg-[#CDEAE1] rounded-[20px] ">
